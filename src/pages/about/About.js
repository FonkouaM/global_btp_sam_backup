  ...
  return (
    <Fragment>
      <div className="dark_page full-page"
           id="about-page"
           style={{ 
             backgroundImage: `url(/assets/img/site_construction.jpg)`,
        ...
        <div className="global_container container py-5">
          ...
          <div className="row mt-5">
            <div className="col-md-4">
              <h4>Notre Vision</h4>
              <p>Construire un avenir meilleur grâce à l’innovation et à la créativité.</p>
            </div>
            <div className="col-md-4">
              <h4>Nos Valeurs</h4>
            ...
            <div className="col-md-4">
              <h4>Notre Équipe</h4>
              <p>Des professionnels expérimentés et passionnés travaillant ensemble pour réussir.</p>
            </div>
          </div>
        </div>
      </div>
